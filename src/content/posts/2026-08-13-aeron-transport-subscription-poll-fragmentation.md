...
本文以 **Aeron 1.52.2** 源码与 Javadoc 为基线，从 Image 的 position 推进机制解释这些边界。发送侧的 term、MTU 和 `offer` 见 [Publication、Log Buffer 与发送热路径](/signal-grid-blog/posts/aeron-transport-publication-log-buffer-offer-try-claim/)。
