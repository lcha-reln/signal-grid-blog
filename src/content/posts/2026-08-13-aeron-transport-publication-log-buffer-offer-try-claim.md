...
updated: 2026-08-13T09:20:00+08:00
tags:
  - Aeron
  - Aeron Transport
  - Publication
...
建议先读 [Transport 第 1 篇：Channel、Stream、Session 与 Image](/signal-grid-blog/posts/aeron-transport-channel-stream-session-image/)，确认 Publication session 是一个独立顺序域。
