...
本文是“交易系统”学习路径的 Chapter 09。建议先读 [Chapter 06：订单簿与自成交保护](/signal-grid-blog/posts/order-book-and-self-trade-prevention/) 和 [Chapter 07：撮合机制](/signal-grid-blog/posts/matching-engine-and-auctions/)；[Chapter 08：OMS 与私有执行回报](/signal-grid-blog/posts/oms-private-execution-reports-and-reconciliation/) 已解释客户端如何恢复私有订单事实，本文则说明同一撮合输出如何成为可复制、可恢复的公开行情。下一章再进入 [合约仓位生命周期](/signal-grid-blog/posts/position-lifecycle-and-pnl/)。
