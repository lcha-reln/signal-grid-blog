...
本文是交易系统学习路径的 Chapter 12，也是综合应用章。它会用到 [订单簿与自成交保护](/signal-grid-blog/posts/order-book-and-self-trade-prevention/)、[订单委托与执行策略](/signal-grid-blog/posts/order-types-and-execution-strategies/) 以及 [仓位生命周期与盈亏](/signal-grid-blog/posts/position-lifecycle-and-pnl/) 中的概念。
