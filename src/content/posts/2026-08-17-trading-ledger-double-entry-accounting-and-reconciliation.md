...
本文是“交易系统”学习路径的 Chapter 08。前面的 [Chapter 05：撮合机制](/signal-grid-blog/posts/matching-engine-and-auctions/) 解释订单怎样产生 fill，[Chapter 06：合约仓位生命周期](/signal-grid-blog/posts/position-lifecycle-and-pnl/) 与 [Chapter 07：永续资金费率](/signal-grid-blog/posts/perpetual-funding-rate/) 则给出仓位、盈亏和资金费用这些具体现金流；本文把它们统一成可验证的账本模型。下一章 [保证金风险引擎](/signal-grid-blog/posts/margin-metrics-and-mark-price/) 再说明余额与仓位估值怎样进入风险计算。
