...
export const PRACTICE_UNITS: readonly PracticeUnit[] = [
  ...
  },
  {
    ...
    interaction: [
      ...
      "计划中的 L2 Matching Lab 只回放最终 Java Golden 并运行有界教学模型；在 M04 达到内容门禁前不登记 Lab、不创建 public evidence",
    ],
    evidence: [
      ...
      "只有未来 course/m04-complete 的干净提交才允许生成 tag-bound manifest；当前 IN_PROGRESS 不创建 complete tag、evidencePath、evidenceContract、公开副本或 product release",
    ],
