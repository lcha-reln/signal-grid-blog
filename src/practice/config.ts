...
export const PRACTICE_CASES: readonly PracticeCase[] = [
  {
    ...
    status: "BUILDING",
    statusLabel: "SPOT · M08 已发布",
    totalUnits: 32,
    plannedRepositories: 3,
    stack: ["Java", "Aeron Cluster", "Gradle", "Docker", "Astro Labs"],
    theoryPath: "series/trading/",
    theoryLabel: "查看交易系统理论",
    units: ["M00", "M01", "M02", "M03", "M04", "M05", "M06", "M07", "M08"],
    currentUnitCode: "M08",
    currentAction:
      "M08 已发布：单进程、单 shard、caller-serialized 的本地 WAL、ACK 边界、durable identity、genesis recovery、五篇教程与公开 evidence 已原子收口；下一步只评审 M09 Snapshot 合同，不提前注册空单元。",
