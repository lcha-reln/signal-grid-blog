...
export const PRACTICE_CASES: readonly PracticeCase[] = [
  {
    ...
    status: "BUILDING",
    statusLabel: "SPOT · M05 已发布",
    totalUnits: 32,
    plannedRepositories: 3,
    stack: ["Java", "Aeron Cluster", "Gradle", "Docker", "Astro Labs"],
    theoryPath: "series/trading/",
    theoryLabel: "查看交易系统理论",
    units: ["M00", "M01", "M02", "M03", "M04", "M05"],
    currentUnitCode: "M05",
    currentAction:
      "M05 已发布：content-addressed 版本化 order-entry price band、Prepare/Activate fence、规则归因、五篇教程、Matching Lab 与公开 evidence 已原子收口；下一步先评审 M06 operating mode 与 Mass Cancel 合同，不提前注册空单元。",
