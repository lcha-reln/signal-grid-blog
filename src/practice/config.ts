...
export const PRACTICE_CASES: readonly PracticeCase[] = [
  {
    ...
    currentUnitCode: "M09",
    currentAction:
      "M00～M09 已发布；M09 已由 annotated course/m09-complete、完整 commit 与同源静态 evidence 封存。下一步只评审 M10 合同，不创建代码窗口、不注册教程，也不把 M09 扩大为产品 release、Aeron 或高可用资格。",
